...
export const registerUser = async (
  ...
  try {
    const response = await fetch("http://antivirus-backend.us-east-2.elasticbeanstalk.com/api/Auth/register", {
      method: "POST",
      headers: {
...
export const loginUser = async (
  ...
  try {
    const response = await fetch("http://antivirus-backend.us-east-2.elasticbeanstalk.com/api/Auth/login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export async function logout(): Promise<AuthResponse> {
  try {
    ...
    const response = await fetch(
      "http://antivirus-backend.us-east-2.elasticbeanstalk.com/api/Auth/login/logout",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getUsers = async () => {
  try {
    ...
    const response = await fetch("http://antivirus-backend.us-east-2.elasticbeanstalk.com/api/Users/all", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const updateUser = async (
  ...
  try {
    ...
    const response = await fetch(`http://antivirus-backend.us-east-2.elasticbeanstalk.com/api/Users/Updatebyid/${userId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`, // 👈 Agregar el token
